...
func (m *RegistryDefault) SmsNotificationClient() sms.NotificationClient {
	if m.selfserviceSmsNotificationClient == nil {
		m.selfserviceSmsNotificationClient = sms.NewNotificationClient(m)
	}

	return m.selfserviceSmsNotificationClient
}
