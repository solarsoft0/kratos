	...
	t.Run("address verification", func(t *testing.T) {
		...
		for _, tc := range []struct {
			...
			},
			{
				...
				schema: phoneSchemaPath,
				doc:    `{"phones":["+12233344445","+12112112112"]}`,
				existing: []VerifiableAddress{
					{
						Value:      "+12112112112",
						Verified:   true,
			...
			},
			{
				...
				schema: phoneSchemaPath,
				doc:    `{"phones": ["+12233344445","+12233344445","+12112112112"]}`,
				existing: []VerifiableAddress{
					{
						Value:      "+12233344445",
						Verified:   false,
			...
			},
			{
				...
				schema: phoneSchemaPath,
				doc:    `{"phones": ["+12233344445","+12233344445","+12112112112"], "username": "+12312312312"}`,
				expect: []VerifiableAddress{
					{
						Value:      "+12233344445",
						Verified:   false,
